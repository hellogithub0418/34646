...
CREATE TABLE `house`  (
  ...
  `numbers` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `status` int(11) NULL DEFAULT NULL COMMENT '入住状态',
  `into_date` datetime NULL DEFAULT NULL COMMENT '入住时间',
...
CREATE TABLE `repair`  (
  ...
  `building_id` int(11) NULL DEFAULT NULL,
  `problem` datetime NULL DEFAULT NULL,
